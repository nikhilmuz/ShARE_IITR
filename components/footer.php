<div class="footer">
        <div style="background-color: #0aca86;" class="row">
        <div class="col-md-4">
            <p class="footer-heading">About</p>
            <ul class="list">
            <li>Prama Jyoti Foundation (PJF)</li>
            <li>ShARE - IITR</li>
            </ul>
        </div>
        <div class="col-md-4">
        ...
        <div style="height: 35px;" class="col-md-12">
            <p class="footer-copy" align="center">Designed by:&nbsp;&nbsp;&nbsp;&nbsp;<img height="30px" src="assets/images/ds_logo.png"></p>
        </div>
         </div>
            </div>
        </div>
